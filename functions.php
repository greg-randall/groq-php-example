...
function groq_cost($response){
    ...
    $groq_cost = array(
        'Llama' =>      array('input' => 0.70/1000000, 'output' => 0.80/1000000), // Llama 2 70B
        'Mixtral' =>    array('input' => 0.27/1000000, 'output' => 0.27/1000000), // Mixtral, 8x7B SMoE
        'Gemma' =>      array('input' => 0.10/1000000, 'output' => 0.10/1000000), // Gemma 7B
    );
